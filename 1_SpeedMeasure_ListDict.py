...
def get_dataset_time():
    ...
    start_time = time.time()
    for i in range(5):
        for instance in openbook_dataset:
            a = instance["id"]
            b = instance["text"]
            c = instance["label"]
            d = instance["documents"]
...
def main():
    list_dict_time = get_list_dict_time()
    dataset_time = get_dataset_time()

    print("avg time list dict:", list_dict_time)
    print("avg time dataset:", dataset_time)
